...
import com.example.omniseek.service.UserService;
...
public class UploadController {
    ...
    public ResponseEntity<Map<String, Object>> mergeFile(
        ...
        try {
            ...
            String objectUrl = uploadService.mergeChunks(request.fileMd5(), request.fileName()); // 返回合并后的链接
            ...
            // /consumer/FileProcessingConsumer.java下 processTask 方法处理
            // 包括解析文档、切片、调用模型向量化操作
